...
产品用词见仓库根目录 [`CONTEXT.md`](../../CONTEXT.md)。这里只记已经落地的取舍。内容怎么组织见 [`../content.md`](../content.md)，剧情总表见 [`../story/INDEX.md`](../story/INDEX.md)。

| 编号 | 结论 | 现状 |
| --- | --- | --- |
| [0001](0001-ship-vertical-web-first.md) | 先做竖屏网页，不先做微信小游戏包 | 有效 |
| [0002](0002-quiz-is-the-battle.md) | 战斗就是答题 | 有效；另有出招/受伤贴图，仍不是动作操控 |
| [0003](0003-chapters-by-poet.md) | 主线按诗人分章，上有朝代层 | 有效；先秦 / 汉魏 / 唐 / 宋 |
| [0004](0004-one-poem-bank-three-rules.md) | 三种模式共用一份诗文 | 有效；内容在 `src/lib/game/content/` |
...
| [0007](0007-plain-level-names.md) | 直白关卡名；钥匙按章算 | 有效 |
